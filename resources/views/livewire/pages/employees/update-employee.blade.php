...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
    <div class="p-2 sm:p-4 bg-white dark:bg-gray-800 shadow sm:rounded-lg flex justify-between items-center">
        <form method="POST" action="{{ route('employees.update', $employee->id) }}" class="flex flex-col gap-2">
            @csrf
            @method('PUT')
    ...
    <x-modal name="confirm-employee-deletion" focusable>
        <form method="POST" action="{{ route('employees.destroy', $employee->id) }}" class="p-6">
            ...
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                Têm certeza que deseja deletar este colaborador ?
            </h2>
